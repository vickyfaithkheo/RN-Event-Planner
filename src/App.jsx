...
export default function EventBudgetGenerator() {
  ...
  // Budget items (with price and qty)
  ...
  // Calculations for Proposed Budget
  ...
  // Calculated Fund Allocations based on absolute Net Balance magnitude
  ...
  const updateBudgetRow = (setter, id, field, value) =>
    setter((rows) => rows.map((r) => (r.id === id ? { ...r, [field]: value } : r)));
  const addBudgetRow = (setter) =>
    setter((rows) => [...rows, { id: uid(), label: "", price: "", qty: "" }]);
  const removeBudgetRow = (setter, id) =>
    setter((rows) => rows.filter((r) => r.id !== id));

  const updateClaimRow = (id, field, value) =>
    setClaims((rows) => rows.map((r) => (r.id === id ? { ...r, [field]: value } : r)));
  const addClaimRow = () =>
    setClaims((rows) => [
      ...rows,
      {
  ...
  function buildWorkbook() {
    ...
    if (activeNav === "Claim Details") {
      ...
      const balanceLabel = activeNav === "Proposed Budget" ? "ESTIMATED NET BALANCE" : "NET BALANCE";
      push([
        balanceLabel, "", "", "", "",
        ...
        <main className="flex-1 overflow-y-auto p-8 bg-[#f7f9fb]">
          <div className="max-w-[1440px] mx-auto space-y-6 pb-10">
            ...
            {activeNav === "Claim Details" ? (
                            ...
                            <tr key={c.id} className="group hover:bg-[#0058be]/5 transition-colors">
                              ...
                              <td className="px-3 py-3">
                                {isFirst ? (
                                  <input 
                                    ...
                                    value={c.projectName} 
                                    onChange={(e) => updateClaimRow(c.id, "projectName", e.target.value)} 
                              ...
                              <td className="px-3 py-3">
                                <input 
                                  ...
                                  value={c.vendor} 
                                  onChange={(e) => updateClaimRow(c.id, "vendor", e.target.value)} 
                              ...
                              <td className="px-3 py-3">
                                <input 
                                  className="w-full bg-transparent border-none p-1 text-sm focus:bg-white rounded" 
                                  value={c.invoiceNo} 
                                  onChange={(e) => updateClaimRow(c.id, "invoiceNo", e.target.value)} 
                                  placeholder="INV-000" 
                                />
                              </td>
                              <td className="px-3 py-3">
                                <input 
                                  className="w-full bg-transparent border-none p-1 text-sm focus:bg-white rounded" 
                                  value={c.date} 
                                  onChange={(e) => updateClaimRow(c.id, "date", e.target.value)} 
                              ...
                              <td className="px-3 py-3">
                                <textarea 
                                  ...
                                  value={c.itemDetails} 
                                  onChange={(e) => updateClaimRow(c.id, "itemDetails", e.target.value)} 
                              ...
                              <td className="px-3 py-3">
                                <select 
                                  ...
                                  onChange={(e) => updateClaimRow(c.id, "accountGroup", e.target.value)}
                                >
                              ...
                              <td className="px-3 py-3">
                                <select 
                                  className="w-full bg-transparent border-none p-1 text-sm focus:bg-white rounded cursor-pointer" 
                                  value={c.accountDesc} 
                                  onChange={(e) => updateClaimRow(c.id, "accountDesc", e.target.value)}
                                >
                              ...
                              <td className="px-3 py-3 text-right">
                                <input 
                                  ...
                                  value={c.amount} 
                                  onChange={(e) => updateClaimRow(c.id, "amount", e.target.value)} 
                                />
                              </td>
              ...
              /* ---------------- PROPOSED BUDGET & STATEMENT OF ACCOUNTS VIEWS ---------------- */
              <>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <section className="bg-white border border-[#c6c6cd] rounded-lg flex flex-col shadow-sm overflow-hidden">
                    ...
                    <div className="p-6">
                              ...
                              <tr key={r.id} className="border-b border-[#c6c6cd]/50 group">
                                <td className="py-3">
                                  <input
                                    ...
                                    value={r.label}
                                    onChange={(e) => updateBudgetRow(setIncome, r.id, "label", e.target.value)}
                                  />
                                </td>
                                <td className="py-3 px-1">
                                  <input
                                    ...
                                    placeholder="0.00"
                                    value={r.price}
                                    onChange={(e) => updateBudgetRow(setIncome, r.id, "price", e.target.value)}
                                  />
                                </td>
                                <td className="py-3 px-1">
                                  <input
                                    ...
                                    placeholder="1"
                                    value={r.qty}
                                    onChange={(e) => updateBudgetRow(setIncome, r.id, "qty", e.target.value)}
                                  />
                                </td>
                                ...
                                <td className="py-3 text-center">
                                  <button
                                    onClick={() => removeBudgetRow(setIncome, r.id)}
                                    className="text-[#ba1a1a] opacity-0 group-hover:opacity-100 hover:scale-110 transition-all cursor-pointer"
                                  >
                                    <span className="material-symbols-outlined text-sm">delete</span>
                                  </button>
                      ...
                      <button onClick={() => addBudgetRow(setIncome)} className="mt-6 flex items-center text-[#0058be] text-sm font-semibold hover:underline cursor-pointer">
                  ...
                  <section className="bg-white border border-[#c6c6cd] rounded-lg flex flex-col shadow-sm overflow-hidden">
                    ...
                    <div className="p-6">
                              ...
                              <tr key={r.id} className="border-b border-[#c6c6cd]/50 group">
                                <td className="py-3">
                                  <input
                                    ...
                                    placeholder="Description"
                                    value={r.label}
                                    onChange={(e) => updateBudgetRow(setExpenditure, r.id, "label", e.target.value)}
                                  />
                                </td>
                                <td className="py-3 px-1">
                                  <input
                                    ...
                                    placeholder="0.00"
                                    value={r.price}
                                    onChange={(e) => updateBudgetRow(setExpenditure, r.id, "price", e.target.value)}
                                  />
                                </td>
                                <td className="py-3 px-1">
                                  <input
                                    ...
                                    placeholder="1"
                                    value={r.qty}
                                    onChange={(e) => updateBudgetRow(setExpenditure, r.id, "qty", e.target.value)}
                                  />
                                </td>
                                <td className="py-3 text-right">
                                ...
                                <td className="py-3 text-center">
                                  <button
                                    onClick={() => removeBudgetRow(setExpenditure, r.id)}
                                    className="text-[#ba1a1a] opacity-0 group-hover:opacity-100 hover:scale-110 transition-all cursor-pointer"
                                  >
                                    <span className="material-symbols-outlined text-sm">delete</span>
                                  </button>
                      ...
                      <button onClick={() => addBudgetRow(setExpenditure)} className="mt-6 flex items-center text-[#0058be] text-sm font-semibold hover:underline cursor-pointer">
                ...
                {/* Bottom Section: Estimated Net Balance / Net Balance & Funding Allocations */}
                <div className="grid grid-cols-1 gap-6">
                  <div className={`bg-white border-l-4 ${isDeficit ? 'border-[#ba1a1a]' : 'border-[#009668]'} border border-[#c6c6cd] rounded-lg p-6 shadow-sm`}>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
                      ...
                      {/* Net Balance Col */}
                      <div>
                        <h4 className="text-xs font-semibold text-[#45464d] uppercase tracking-widest mb-2">
                          {activeNav === "Proposed Budget" ? "Estimated Net Balance" : "Net Balance"}
                        </h4>
                ...
                {/* Preparation & Authorization Card (3 columns for Proposed Budget, 4 columns for Statement of Accounts) */}
                <div className="bg-white border border-[#c6c6cd] rounded-lg p-6 shadow-sm mt-6">
                  ...
                  <div className={`grid grid-cols-1 md:grid-cols-2 ${activeNav === "Statement of Accounts" ? "lg:grid-cols-4" : "lg:grid-cols-3"} gap-6`}>
                    ...
                    {/* Certified Correct by GCDO Block (Only for Statement of Accounts) */}
